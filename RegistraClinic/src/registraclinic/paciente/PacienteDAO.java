...
public class PacienteDAO extends GenericDAO<Paciente>{
    ...
    public boolean excluir(Paciente paciente) {
        Object[] options = {"Sim", "Não"};
        if (paciente.getIdPaciente() != 0) {
            if (JOptionPane.showOptionDialog(null, "Deseja excluir o(a) Paciente: " + paciente.getNomePaciente()
                ...
                if (remover(paciente)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Não foi possível excluir o(a) Paciente " + paciente.getNomePaciente(),
