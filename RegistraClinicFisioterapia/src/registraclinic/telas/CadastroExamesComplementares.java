...
public class CadastroExamesComplementares extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel6.setMaximumSize(new java.awt.Dimension(597, 424));
        jLabel6.setMinimumSize(new java.awt.Dimension(597, 424));
        jLabel6.setPreferredSize(new java.awt.Dimension(597, 424));
        getContentPane().add(jLabel6);
        jLabel6.setBounds(0, 0, 597, 420);
    ...
    private void btLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLimparActionPerformed
        ...
        btExcluir.setEnabled(false);
        jtExamesComplementares.setText("");
        jtLaudo.setText("");
        txtData.setText("");
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        if (Util.chkVazio(jtExamesComplementares.getText(), jtLaudo.getText(), txtData.getText())) {
            ...
            examesComplementaresDAO.salvar(examesComplementares);
            btLimparActionPerformed(null);
        }
