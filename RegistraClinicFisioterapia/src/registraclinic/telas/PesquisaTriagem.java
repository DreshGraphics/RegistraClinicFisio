...
import registraclinic.triagem.TriagemCellRenderer;
...
public class PesquisaTriagem extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaTriagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaTriagem dialog = new PesquisaTriagem(new javax.swing.JFrame(), true);
